      ...
      <Breadcrumb
        links={[
          { id: 1, title: "خانه", to: "/" },
          {
            id: 2,
            title: "مقاله ها",
            to: "/article-info/front",
          },
          { id: 3, title: "جاوا اسکریپت", to: "/article-info-javascript" },
        ]}
      />
              ...
              <div class="article">
                ...
                <div class="article__score">
                  <div class="article__score-icons">
                    <img src="/images/svgs/star_fill.svg" class="article__score-icon" alt="" />
                    <img src="/images/svgs/star_fill.svg" class="article__score-icon" alt="" />
                    <img src="/images/svgs/star_fill.svg" class="article__score-icon" alt="" />
                    <img src="/images/svgs/star_fill.svg" class="article__score-icon" alt=""/>
                    <img src="/images/svgs/star.svg" class="article__score-icon" alt=""/>
                  </div>
                ...
                <div class="article-read">
                  ...
                  <ul class="article-read__list">
                    <li class="article-read__item">
                      <a href="w" class="article-read__link">معرفی بهترین سایت ‌های آموزش جاوا اسکریپت:</a>
                    </li>
                    <li class="article-read__item">
                      <a href="w" class="article-read__link">یک راه آسان‌تر، دوره‌ های جاوا اسکریپت آکادمی سبزلرن!</a>
                    </li>
                    <li class="article-read__item">
                      <a href="w" class="article-read__link">ثبت نام در دوره‌ های جاوا اسکریپت سبزلرن:</a>
                    </li>
                  </ul>
                </div>

                <img src="/images/blog/2.jpg" alt="Article Img" class="article__seconadary-banner" />
                <div class="article-section" dangerouslySetInnerHTML={{__html: domPurify.sanitize(articleDetails.body)}}>
                </div>
                <div class="article-social-media">
                  <span class="article-social-media__text">اشتراک گذاری :</span>
                  <a href="w" class="article-social-media__link">
                ...
                <div class="row">
                  <div class="col-6">
                    <div class="suggestion-articles__right suggestion-articles__content">
                      <a href="w" class="suggestion-articles__icon-link">
                        <i class="fas fa-arrow-right suggestion-articles__icon"></i>
                      </a>
                      <a href="w" class="suggestion-articles__link">
                  ...
                  <div class="col-6">
                    <div class="suggestion-articles__left suggestion-articles__content">
                      ...
                      <a href="w" class="suggestion-articles__link">
                        سریع ترن و بهترین راه یادگیری جاوا اسکریپت چیست؟ | تجربه برنامه نویسان
                      </a>
                    </div>
                  </div>
                </div>
