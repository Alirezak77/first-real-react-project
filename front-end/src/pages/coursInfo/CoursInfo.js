...
export default function CoursInfo() {
     ...
     async function  fetchData()  {
      ...
      try {
        const res = await fetch(
          `http://localhost:4000/v1/courses/${coursName}`,
          {
            method: "POST",
            headers: {
  ...
  fetch(`http://localhost:4000/v1/courses/related/${courseDetail._id}`)
    .then((res) => res.json())
    .then((data) => setRelatedCourse(data.relatedCourses))
    ...
    <>
      ...
      <Breadcrumb
        links={[
          { id: 1, title: "خانه", to: "/" },
          {
            ...
            to: "/categori-info/front",
          },
          { id: 3, title: "آموزش جاوا اسکریپت", to: "/cours-info-javascript" },
        ]}
      />
      ...
      <section class="course-info">
        <div class="container">
          <div class="row">
            <div class="col-6">
              <a href="w" class="course-info__link">
              ...
              <div class="course">
                ...
                <div class="introduction">
                  ...
                  <div class="introduction__btns">
                    <a href="w" class="introduction__btns-item">
                  ...
                  <div class="techer-details__header">
                    <div class="techer-details__header-right">
                      ...
                      <div class="techer-details__header-titles">
                        <a href="w" class="techer-details__header-link">
                          محمدامین سعیدی راد
                        </a>
                  ...
                  <ul class="course-info__courses-list">

                    {
                      relatedCourse.map(course=>{
                        return <li class="course-info__courses-list-item">
